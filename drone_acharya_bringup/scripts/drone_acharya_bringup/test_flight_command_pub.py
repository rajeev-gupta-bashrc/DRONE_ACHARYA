...
class DronePublisher(Node):
    def __init__(self, del_throttle, throttle):
        ...
        self.rotor1_pub = self.create_publisher(Float64, '/drone_v2/rotor_0_joint/cmd_roll', 10)
        self.rotor2_pub = self.create_publisher(Float64, '/drone_v2/rotor_1_joint/cmd_roll', 10)
        self.rotor3_pub = self.create_publisher(Float64, '/drone_v2/rotor_2_joint/cmd_roll', 10)
        self.rotor4_pub = self.create_publisher(Float64, '/drone_v2/rotor_3_joint/cmd_roll', 10)
...
def main(args=None):
    ...
    parser.add_argument('--del_throttle', type=float, default=0.0, help='Delta Throttle value')
